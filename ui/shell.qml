            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        OLabel { palette: app.palette; text: app.dialog === 'workspace' ? 'An occupied destination swaps places. Both layouts stay together.' : app.dialog === 'restore' ? 'Reopen saved apps and restore their workspaces and layout.\nExisting windows are reused where possible; no apps are closed.' : app.dialog === 'swap' ? 'Choose the window whose position you want.' : 'Choose a workspace. Your window moves without switching your view.'; font.pixelSize: SystemStyle.font.body; opacity: .6; wrapMode: Text.Wrap; Layout.fillWidth: true }
                        GridLayout {
